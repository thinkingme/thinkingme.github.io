...
![](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/core-points/pass-by-value-01.png)
...
![](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/core-points/pass-by-value-02.png)
...
![](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/core-points/pass-by-value-03.png)

当 `modify()` 方法调用结束后，改变了形参 name1 的地址，但 `main()` 方法中 name 并没有发生改变。

![](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/core-points/pass-by-value-04.png)
