...
![](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/overview/fourteen-01.png)
...
![](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/overview/fourteen-02.png)
...
![](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/overview/fourteen-03.png)

**第二步**，执行 javadoc 命令 `javadoc Demo.java -encoding utf-8`。`-encoding utf-8` 可以保证中文不发生乱码。

![](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/overview/fourteen-04.png)

**第三步，**执行 `ls -l` 命令就可以看到生成代码文档时产生的文件，主要是一些可以组成网页的 html、js 和 css 文件。

![](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/overview/fourteen-05.png)

**第四步**，执行 `open index.html` 命令可以通过默认的浏览器打开文档注释。

![](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/overview/fourteen-06.png)

点击「Demo」，可以查看到该类更具体的注释文档。

![](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/overview/fourteen-07.png)
...
![](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/overview/fourteen-08.png)
...
![](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/overview/fourteen-09.png)
...
![](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/overview/fourteen-10.png)
