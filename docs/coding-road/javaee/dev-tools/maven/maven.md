...
![](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/maven/maven-01.png)
...
![](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/maven/maven-02.png)
...
![](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/maven/maven-03.png)
...
![](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/maven/maven-04.png)

第三步，配置环境变量

打开终端，输入 `vim ~/.bash_profile` 命令打开 bash_profile 文件：

![](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/maven/maven-05.png)
...
![](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/maven/maven-06.png)

保存后退出，可以执行 `source ~/.bash_profile` 使配置生效：

![](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/maven/maven-07.png)

第四步，查看配置是否生效

输入 `mvn -v` 命令，如果输出以下内容，表示配置成功：

![](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/maven/maven-08.png)
...
![](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/maven/maven-09.png)
...
![](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/maven/maven-10.png)

有了传递性依赖机制，在使用 Spring Framework 的时候就不用去考虑它依赖了什么，也不用担心引入多余的依赖。Maven 会解析各个直接依赖的 POM，将那些必要的间接依赖，以传递性依赖的形式引入到当前的项目中。

关于**依赖可选**：

![](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/maven/maven-11.png)
...
![](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/maven/maven-12.png)

仓库可以以下几种：

![](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/maven/maven-13.png)
...
- repositories 可以包含一个或者多个 repository 元素，以声明一个或者多个仓库。
...
![](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/maven/maven-14.png)
...
![](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/maven/mvnd-01.png)
...
![](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/maven/mvnd-02.png)
...
![](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/maven/mvnd-03.png)

下载完成后解压，然后把 bin 目录添加到 PATH 路径下。

在终端执行 `mvnd -v` 就可以查看到 mvnd 的配置信息了。

![](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/maven/mvnd-04.png)

如果出现类似下面这样的错误，未找到 JAVA_HOME，可以按照提示在对应的文件中追加 java.home 属性，也就是 JDK 的安装路径。

![](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/maven/mvnd-05.png)

刚好之前搭建了一个 Spring Boot 项目，我们可以拿 Maven 和 mvnd 来对比一下构建速度。

先执行 `mvn clean package` 命令，一共花费的时间是 5.318 秒。

![](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/maven/mvnd-06.png)

再执行 `mvnd clean package` 命令，一共花费的时间是 3.225 秒。

![](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/maven/mvnd-07.png)
...
![](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/maven/mvnd-08.gif)
