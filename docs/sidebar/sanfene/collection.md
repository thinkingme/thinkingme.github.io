...
![Java集合主要关系](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/sidebar/sanfene/collection-1.png)
...
![ArrayList和LinkedList的数据结构](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/sidebar/sanfene/collection-2.png)
...
![ArrayList和LinkedList中间插入](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/sidebar/sanfene/collection-3.png)

![ArrayList和LinkedList中间删除](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/sidebar/sanfene/collection-4.png)
...
![ArrayList扩容](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/sidebar/sanfene/collection-5.png)
...
![ArrayList自定义序列化](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/sidebar/sanfene/collection-6.png)
...
![CopyOnWriteArrayList原理](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/sidebar/sanfene/collection-7.png)
...
![jdk1.8 hashmap数据结构示意图](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/sidebar/sanfene/collection-8.png)
...
![红黑树](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/sidebar/sanfene/collection-9.png)
...
![左旋](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/sidebar/sanfene/collection-10.png)

![右旋](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/sidebar/sanfene/collection-11.png)

- 染⾊：

![染色](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/sidebar/sanfene/collection-12.png)

### 11.HashMap 的 put 流程知道吗？

先上个流程图吧:

![HashMap插入数据流程图](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/sidebar/sanfene/collection-13.jpg)
...
![HashMap查找流程图](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/sidebar/sanfene/collection-14.png)
...
![哈希&运算](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/sidebar/sanfene/collection-15.png)
...
![扰动函数示意图](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/sidebar/sanfene/collection-16.jpg)
...
![put中的扩容](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/sidebar/sanfene/collection-17.png)
...
![容量计算](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/sidebar/sanfene/collection-18.png)
...
![散列函数构造](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/sidebar/sanfene/collection-19.png)
...
![开放定址法](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/sidebar/sanfene/collection-20.png)
...
![源码注释](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/sidebar/sanfene/collection-21.png)
...
![put时，扩容](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/sidebar/sanfene/collection-22.png)

而这个`临界值threshold`就是由加载因子和当前容器的容量大小来确定的，假如采用默认的构造方法：

> 临界值（threshold ）= 默认容量（DEFAULT_INITIAL_CAPACITY） \* 默认扩容因子（DEFAULT_LOAD_FACTOR）

![threshold计算](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/sidebar/sanfene/collection-23.png)
...
![关于默认负载因子的注释](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/sidebar/sanfene/collection-24.png)
...
![扩容之后的索引计算](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/sidebar/sanfene/collection-25.png)

元素在重新计算 hash 之后，因为 n 变为 2 倍，那么 n-1 的 mask 范围在高位多 1bit(红色)，因此新的 index 就会发生这样的变化：

![扩容位置变化](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/sidebar/sanfene/collection-26.png)

所以在扩容时，只需要看原来的 hash 值新增的那一位是 0 还是 1 就行了，是 0 的话索引没变，是 1 的化变成`原索引+oldCap`，看看如 16 扩容为 32 的示意图：

![扩容节点迁移示意图](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/sidebar/sanfene/collection-27.png)

扩容节点迁移主要逻辑：

![扩容主要逻辑](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/sidebar/sanfene/collection-28.png)
...
![自定义HashMap整体结构](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/sidebar/sanfene/collection-29.png)

完整代码：

![完整代码](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/sidebar/sanfene/collection-30.png)
...
![1.7ConcurrentHashMap示意图](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/sidebar/sanfene/collection-31.png)
...
![ConcurrentHashmap jdk1.8put流程](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/sidebar/sanfene/collection-32.jpg)
...
![Entry节点](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/sidebar/sanfene/collection-33.png)

可以实现按插入的顺序或访问顺序排序。

![LinkedHashMap实现原理](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/sidebar/sanfene/collection-34.png)
...
![TreeMap](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/sidebar/sanfene/collection-35.png)
...
![HashSet套娃](https://cdn.jsdelivr.net/gh/thinkingme/thinkingme.github.io@master/images/sidebar/sanfene/collection-36.png)
